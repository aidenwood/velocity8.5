...
import { StatCardSkeleton, ChartSkeleton, ProjectCardSkeleton } from './Skeleton';
...
function OverviewContent() {
  ...
  useEffect(() => {
    // Show onboarding if user has no name set
  ...
  return (
    <DashboardShell currentPath="/dashboard">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-primary-400/60">Here's a summary of your projects.</p>
      </div>
      ...
      <div className="mt-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-primary-500/10 bg-primary-950/40 py-12 backdrop-blur-sm">
            ...
            <p className="text-sm text-primary-400/50">Analytics data will appear here once connected.</p>
          </div>
        )}
      </div>
      ...
      <div className="mt-6">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-primary-500/10 bg-primary-950/40 py-12 backdrop-blur-sm">
            ...
            <p className="text-sm text-primary-400/50">No projects yet. They'll appear here once Aiden sets them up.</p>
          </div>
        )}
      </div>
    </DashboardShell>
